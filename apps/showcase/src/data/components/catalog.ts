  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: 'Toggle',
        slug: 'toggle',
        description: 'Checkbox、Radio、Switch、Decide 切换控件。',
        status: 'implemented',
        children: [
          ...catalogBodyWithScenesSection('toggle-checkbox', 'Checkbox', 'checkbox-scenes'),
          ...catalogBodyWithScenesSection('toggle-radio', 'Radio', 'radio-scenes'),
          ...catalogBodyWithScenesSection('toggle-switch', 'Switch', 'switch-scenes'),
          ...catalogBodyWithScenesSection('toggle-decide', 'Decide', 'decide-scenes'),
        ],
      },
      {
        name: 'Tab',
