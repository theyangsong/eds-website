...
import { cryptoNames, getProcessedCrypto } from '@eds/website-components';
import {
  buildVueOpeningTag,
...
export const flotationItemImportCode = `import { EgFlotationMenuItem } from '@eds/website-components';`;
