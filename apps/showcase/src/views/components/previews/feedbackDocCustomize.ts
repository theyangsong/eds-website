...
export const endFeedbackCardImportCode = `import { EgEndFeedbackCard } from '@eds/website-components';`;
export const toastImportCode = `import { EgToast } from '@eds/website-components';`;
export const messageImportCode = `import { EgMessage } from '@eds/website-components';`;
export const reddotImportCode = `import { EgReddot } from '@eds/website-components';`;
export const formSubmissionImportCode = `import { EgFormSubmission } from '@eds/website-components';`;
export const streamerImportCode = `import { EgStreamer } from '@eds/website-components';`;
