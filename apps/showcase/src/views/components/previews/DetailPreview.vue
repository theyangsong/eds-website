...
import { EgDetail, EgPopup, EgTooltip } from '@eds/website-components';
...
<template>
  <div :class="styles.previewPage">
    <ComponentDocLayout
      ...
      import-code="import { EgDetail } from '@eds/website-components';"
      :customize-controls="[]"
    ...
    >
      <template #preview>
        <div class="showcaseTokens" :class="organismStyles.previewOrganismPopupBoxHost">
          <EgTooltip
            panel-kind="popup"
