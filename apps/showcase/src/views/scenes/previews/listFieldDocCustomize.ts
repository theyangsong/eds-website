...
import { formatGroupedNumber, hasAddressTags } from '@eds/website-components';
import {
...
const CRYPTO_COMBO_IMPORT = `import { EgCryptoCombo } from '@eds/website-components';`;
...
const addressConfig: ListFieldDocConfig = {
  ...
  importCode: `import { EgCryptoAddress, EgListFieldAddressLine } from '@eds/website-components';`,
...
const actionConfig: ListFieldDocConfig = {
  ...
  importCode: `import { EgDataList, EgDataListColumn } from '@eds/website-components';`,
